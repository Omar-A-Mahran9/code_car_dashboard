...
class BankOffer extends Model
{
    ...
    {
        return $this->belongsToMany(Sector::class)->withPivot(["benefit", "support", "advance", "installment","administrative_fees","Last_patch"]);
    }
    ...
    public function attachSectors($pivotData)
    {
        ...
        foreach (Sector::get() as $sector) {
            $this->sectors()->attach($sector, [
                ...
                "Last_patch" => $pivotData[$sector->slug]["Last_patch"] ,
