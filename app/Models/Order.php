...
class Order extends Model
{
    ...
    public function orderDetailsCarselect()
    {
        return $this->belongsTo(CarOrder::class, 'car_order_id'); // Ensure 'order_id' is the correct foreign key
    }
