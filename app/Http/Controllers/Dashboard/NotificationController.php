...
class NotificationController extends Controller
{
    ...
    {
        $notification = Auth::user()->notifications->where('id', $id)->first() ?? Employee::first()->notifications->where('id', $id)->first();
    ...
    public function changeSoundStatus(Request $request) {
        ...
        settings()->updateSetting('notification_status' ,$request->status);   
        if (settings()->getSettings('notification_status')==true) {
