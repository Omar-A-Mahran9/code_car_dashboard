                ...
                <div class="inputs-wrapper">
                    ...
                    <div class="row mb-8">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                <input readonly disable type="text" class="form-control" id="title_ar_inp" name="title_ar"
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                <input readonly disable type="text" class="form-control" id="title_en_inp" name="title_en"
                    ...
                    <div class="row mb-10">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <textarea readonly class="form-control" rows="4" name="description_ar" id="meta_tag_description_ar_inp">{!! $bankOffer->description_ar ?? '' !!}</textarea>
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <textarea readonly class="form-control" rows="4" name="description_en" id="meta_tag_description_en_inp">{!! $bankOffer->description_en ?? '' !!}</textarea>
                    ...
                    <div class="row mb-10">
                        <div class="col-md-6 fv-row">
                            ...
                            <input readonly disable type='date' name="from" value="{{ $bankOffer->from }}"
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <input readonly disable type='date' name="to" value="{{ $bankOffer->to }}"
                                class="form-control form-control-solid  border-gray-300 border-1 filter-datatable-inp me-4"
                                 placeholder="{{ __('Choose the date') }}" data-filter-index="6" />
                    ...
                    <div class="row mb-10">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <select readonly disable class="form-select" multiple data-control="select2" name="brand_id[]" id="brand-sp"
                    ...
                    @foreach ($bankOffer->sectors as $bankSector)
                        ...
                        <div class="row mb-8">
                            ...
                            <div class="col-md-2 fv-row">
                                ...
                                <div class="form-floating">
                                    <input readonly disable style="direction: {{ isArabic() ? 'rtl' : '' }}" type="number"
                                        class="form-control" id="{{ $bankSector->slug }}_benefit_inp"
                                        name="{{ $bankSector->slug }}[benefit]"
                                        value="{{ $bankSector['pivot']['benefit'] }}" placeholder="example" step="0.01" />
                        ...
                        <div class="col-md-2 fv-row">
                            ...
                            <div class="form-floating">
                                <input readonly disable style="direction: {{ isArabic() ? 'rtl' : '' }}" type="text" class="form-control" id="{{$bankSector->slug}}_non_transferred_benefit_inp" name="{{$bankSector->slug}}[non_transferred_benefit]"  value="{{$bankSector['pivot']['non_transferred_benefit']}}" placeholder="example" step="0.01"/>
                        ...
                        <!-- end   :: Column --> --}}
                            ...
                            <div class="col-md-2 fv-row">
                                ...
                                <div class="form-floating">
                                    <input readonly disable style="direction: ltr" type="number" class="form-control"
                                        id="{{ $bankSector->slug }}_support_inp" name="{{ $bankSector->slug }}[support]"
                                        value="{{ $bankSector['pivot']['support'] }}" placeholder="example" step="0.01"/>
                            ...
                            <div class="col-md-2 fv-row">
                                ...
                                <div class="form-floating">
                                    <input readonly disable style="direction: ltr" type="number" class="form-control"
                                        ...
                                        name="{{ $bankSector->slug }}[administrative_fees]" placeholder="example" step="0.01"/>
                            ...
                            <div class="col-md-2 fv-row">
                                ...
                                <div class="form-floating">
                                    <input readonly disable style="direction: ltr" type="number" class="form-control"
                                        ...
                                        name="{{ $bankSector->slug }}[advance]" placeholder="example" step="0.01"/>
                    ...
                    <!-- begin :: Column -->
                            <div class="col-md-2 fv-row">
                                <label class="fs-5 fw-bold mb-2">{{ __('The last installment') }}%</label>
                                <div class="form-floating">
                                    <input readonly disable style="direction: {{ isArabic() ? 'rtl' : '' }}" type="number"
                                        class="form-control"
                                        id="{{ $bankSector->slug }}_Last_patch" name="{{ $bankSector->slug }}[Last_patch]"   value="{{$bankSector['pivot']['Last_patch']}}"
                                        placeholder="example" step="0.01"/>
                                    <label for="Last_patch">{{ __('The last installment amount') }}</label>
                                </div>
                                <p class="invalid-feedback" id="{{ $bankSector->slug }}_Last_patch"></p>
                            </div>
                            <!-- end   :: Column -->
