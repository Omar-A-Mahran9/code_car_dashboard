                        ...
                        <div class="row mb-8">
                            ...
                            <div class="col-md-2 fv-row">
                                ...
                                <div class="form-floating">
                                    <input style="direction: {{ isArabic() ? 'rtl' : '' }}" type="number"
                                        ...
                                        name="{{ $sector->slug }}[support]" placeholder="example" step="0.01" />
                            ...
                            <div class="col-md-2 fv-row">
                                ...
                                <div class="form-floating">
                                    <input style="direction: {{ isArabic() ? 'rtl' : '' }}" type="number"
                                        min="0" value="0" class="form-control"
                                        id="{{ $sector->slug }}_Last_patch" name="{{ $sector->slug }}[Last_patch]"
                                        placeholder="example" step="0.01" />
                                    <label for="Last_patch">{{ __('The last installment amount') }}</label>
                                </div>
                                <p class="invalid-feedback" id="{{ $sector->slug }}_Last_patch"></p>
                            </div>
                            <!-- end   :: Column -->
