                ...
                <div class="inputs-wrapper">
                    ...
                    <div class="row mb-10">
                        <div class="col-md-6 fv-row">
                            ...
                            <input type='date' name="from" value="{{ $bankOffer->from }}"
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <input type='date' name="to" value="{{ $bankOffer->to }}"
                                class="form-control form-control-solid  border-gray-300 border-1 filter-datatable-inp me-4"
                                 placeholder="{{ __('Choose the date') }}" data-filter-index="6" />
                    ...
                    @foreach ($bankOffer->sectors as $bankSector)
                        ...
                        <div class="col-md-2 fv-row">
                            ...
                            <div class="form-floating">
                                <input style="direction: {{ isArabic() ? 'rtl' : '' }}" type="text" class="form-control" id="{{$bankSector->slug}}_non_transferred_benefit_inp" name="{{$bankSector->slug}}[non_transferred_benefit]"  value="{{$bankSector['pivot']['non_transferred_benefit']}}" placeholder="example" step="0.01"/>
