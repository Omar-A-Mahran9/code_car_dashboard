...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body p-0">
            <!-- begin :: Form -->
            <form action="{{ route('dashboard.splash.store') }}" class="form" method="post" id="submitted-form"
                data-redirection-url="{{ route('dashboard.splash.index') }}">
                @csrf
                <!-- begin :: Card header -->
                <div class="card-header d-flex align-items-center">
                    <h3 class="fw-bolder text-dark"> {{ __('Add new splash screen') }}
                    </h3>
                </div>
                <!-- end   :: Card header -->
                ...
                <div class="inputs-wrapper">
                    ...
                    <div class="row mb-8">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                <textarea class="form-control" id="description_ar_inp" name="description_ar" rows="4" placeholder="example"></textarea>
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                <textarea class="form-control" id="description_en_inp" name="description_en" rows="4" placeholder="example"></textarea>
