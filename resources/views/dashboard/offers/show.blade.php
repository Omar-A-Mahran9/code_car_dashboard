            ...
            <div class="card-header d-flex align-items-center">
                ...
                <div class="card-title">
                    ...
                    <div class="form-check form-switch form-check-custom form-check-solid mb-2">
                        ...
                        <input class="form-check-input mx-2" style="height: 18px;width:36px;" type="checkbox" disabled @if( $offer['highlighted'] ) checked @endif   />
                    </div>
                    ...
                    <!-- begin :: Column -->
                        ...
                        <div class="d-flex flex-column">
                           ...
                           <div class="d-flex flex-column">
                            ...
                            <x-dashboard.upload-image-inp name="cover" :image="$offer->cover" directory="Offers" placeholder="default.jpg" type="show" ></x-dashboard.upload-image-inp>
                            <!-- end   :: Upload image component -->
                        </div>
                        </div>
