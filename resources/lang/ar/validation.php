...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'carـcount' => 'عدد السيارات',
        'Deduction_rate_with_mortgage_max' => 'نسبة استقطاع القرض العقاري',
        'Deduction_rate_with_mortgage_min' => 'نسبة استقطاع القرض العقاري',
        'Deduction_rate_with_support_mortgage_max' =>' نسبة استقطاع القرض العقاري المدعوم',
        'Deduction_rate_with_support_mortgage_min' => 'نسبة استقطاع القرض العقاري المدعوم',
        'Deduction_rate_without_mortgage_max' => 'نسبة استقطاع بدون القرض العقاري',
        'Deduction_rate_without_mortgage_min' => 'نسبة استقطاع بدون القرض العقاري',
        'max_salary' => 'الراتب الأقصى',
        'min_salary' => 'الراتب الأدنى',
        'monthely_installment' => 'القسط الشهري',
        'financeـamount' => 'قيمة التمويل',
        'firstـpaymentـvalue' => 'قيمة الدفعة الأولى',
        'lastـpaymentـvalue' => 'قيمة الدفعة الأخيرة',
