  ...
  $.ajax({
    ...
    success: function (data) {
      ...
      if (Object.keys(data).length > 0) {
        ...
        if (data.car) {
          document.getElementById("car_name_inp").innerHTML =
            data.car.name + " ";
        } else {
          // If car name or color is not available, hide the sections
          document.getElementById("car_name_section").innerHTML = " ";
        }

        if (data.color_id) {
          document.getElementById("car_color_inp").innerHTML =
            data.color.name + " ";
        } else {
          document.getElementById("car_color_section").innerHTML = " ";
        }
        ...
        document.getElementById("city_inp").innerHTML = data.city.name + " ";

        document.getElementById("phone").value = data.phone
          ? data.phone
          : "Not have Phone";
        document.getElementById("phone_inp").innerHTML = data.phone + " ";

        //   if (data.color_id) {
        //         document.getElementById("car_color_inp").innerHTML = data.color.name;
        //     } else {
        ...
        if (data == true) {
          errorAlert(__("This order have finance approval before"), 5000);
